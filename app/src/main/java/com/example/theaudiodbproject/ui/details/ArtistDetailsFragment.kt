package com.example.theaudiodbproject.ui.details
...
class ArtistDetailsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Pour récupérer les données de l'argument Bundle
        val artistId = arguments?.getString(ARG_ARTIST_ID)
        // Faites ce que vous devez faire avec l'ID de l'artiste ici
    }
